...
* Номер
//	И в поле с именем 'Номер' я ввожу текст 'ПА00-001521'
//	Тогда открылось окно '1С:Предприятие'
//	И я нажимаю на кнопку с именем 'Button0'
//	И в поле с именем 'Номер' я ввожу текст 'ПА00-001522'
...
//	| 'Артикул '       | 'Бренд' | 'Наименование'         | 'Основное место хранения' | 'Порядок' | 'Производитель (бренд)' |
//	| 'BAXI под заказ' | 'BAXI'  | 'Товар' | '6'                       | '14'      | 'БАКСИ'                 |
//И в таблице "ИерархияНоменклатуры" я разворачиваю строку:
//	| 'Группа номенклатуры'                    |
//	| 'Газовые  котлы и аксессуары (00000002)' |
//И в таблице "ИерархияНоменклатуры" я разворачиваю строку:
//	| 'Группа номенклатуры' |
//	| '1.BAXI (00000802)'   |
//И в таблице "ИерархияНоменклатуры" я разворачиваю строку:
//	| 'Группа номенклатуры'          |
//	| '6.Конденсационные котлы BAXI' |
